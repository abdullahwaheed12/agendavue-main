...
import 'package:agendavue/presentation/missing_work_screen/missing_work_screen.dart';
...
class CompleteWorkScreen extends StatefulWidget {
  const CompleteWorkScreen({Key? key}) : super(key: key);

  @override
  State<CompleteWorkScreen> createState() => _CompleteWorkScreenState();
}

class _CompleteWorkScreenState extends State<CompleteWorkScreen> {
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: ListView.builder(
                    itemCount: StudentApiCall.complete.length,
                    itemBuilder: (context, index) {
                      var assignment = StudentApiCall.complete[index];
                        ...
                        trailingActions: <SwipeAction>[
                          SwipeAction(
                              ...
                              onTap: (CompletionHandler handler) async {
                                StudentApiCall.missing.add(assignment);
                                StudentApiCall.complete.remove(assignment);
        ...
        Container(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton2(
              ...
              value: selectedValue,
              onChanged: (value) {
                if (value == 'Missing Work') {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MissingWorkScreen(),
                      ));
                }
                setState(() {
